...
import com.app.notesculture.model.Navigation_Items;
import com.app.notesculture.view.adapter.Navigation_Drawer_Adapter;
import com.app.notesculture.view.ui.fragment.AboutUs_Fragment;
import com.app.notesculture.view.ui.fragment.Messages_Fragment;
import com.app.notesculture.view.ui.fragment.Settings_Fragment;
import com.app.notesculture.view.ui.fragment.SubjectDetailFragment;
import com.app.notesculture.view.ui.fragment.UserAccount_Fragment;
...
public class ActivityMain extends AppCompatActivity {
    ...
    void init() {
        ...
        actionbarToggle = new ActionBarDrawerToggle(this, drawer,
            ...
            public void onDrawerClosed(View drawerView) {
                Toast.makeText(ActivityMain.this, "Drawer Close",
            ...
            public void onDrawerOpened(View drawerView) {
                Toast.makeText(ActivityMain.this, "Drawer Open",
                        Toast.LENGTH_SHORT).show();
                super.onDrawerOpened(drawerView);
            }

        };
        //actionbarToggle.getDrawerArrowDrawable().setColor(Color.RED);
        drawer.setDrawerListener(actionbarToggle);
    }

    // Populate navigation drawer listitems
    void populateListItems() {
        Integer Icons[] = { R.drawable.home, R.drawable.phone,
                R.drawable.download, R.drawable.website,
                R.drawable.follow_us,R.drawable.terms_condition, R.drawable.about_us,
                R.drawable.policy, R.drawable.logout,
        };
        ...
        for (int i = 0; i < Icons.length; i++) {
            arrayList
                    .add(new Navigation_Items(title[i], Icons[i]));
        }

        adapter = new Navigation_Drawer_Adapter(ActivityMain.this, arrayList);
    ...
    public void selectItem(int position) {
        ...
        switch (position) {
            case 0:
                replaceFragment(new SubjectDetailFragment(), "Home");
                break;
            case 1:
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.menu_navigation);
